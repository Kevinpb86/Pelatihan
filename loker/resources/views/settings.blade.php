            ...
            <nav class="mt-6 px-4">
                <div class="space-y-2">
                    ...
                    @else
                        ...
                        <a href="{{ route('store-item') }}" onclick="animateAndNavigate(event, '{{ route('store-item') }}')" class="nav-item btn-animate flex items-center px-4 py-3 text-sm font-medium text-white/80 hover:text-white rounded-xl transition-all duration-300">
            ...
            <div class="absolute bottom-0 w-64 p-6 border-t border-white/20">
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-3 flex-1">
                        ...
                        @if(Auth::user()->role === 'admin')
                            <span class="inline-flex items-center px-2 py-0.5 mt-1 rounded-full text-xs font-medium bg-green-500/20 text-green-300 border border-green-500/30">Admin</span>
                        @endif
                    </div>
                </div>
